...
data$wage <- as.factor(data$wage)
boruta_output <- Boruta(wage~., data = data_encoded, doTrace=2)
...
```{r}
## Use your model to predict churn on new data, here: A single observation.
