...
The 63 features are: (Evtl am ende löschen da die Anzeige oben ist.. )
 [1] "gender"
 [2] "age"
 [3] "country"
 [4] "education"
...
Lets have a look at the best of those GMB models.
...
Interesting is the RMSE, which is still 21'095 dollar which means, that every output has a deviation of +/- 21'095$ which is not that great for predicting wage. 
Now we predict our salaries:
